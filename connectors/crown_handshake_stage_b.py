"""Stage B MCP connector aligning the Crown mission brief handshake."""
...
_CONNECTOR = StageBConnector(
    StageBConnectorConfig(
        ...
        registry_id="crown_handshake_stage_b",
        module_path="connectors/crown_handshake_stage_b.py",
        version=__version__,
        env_prefix="CROWN_HANDSHAKE_STAGE_B",
        supported_channels=("handshake", "heartbeat", "mission-brief"),
        capabilities=("register", "telemetry", "mission-brief"),
        chakra="crown",
        token_hint_default="crown",
    ),
    logger=LOGGER,
)
...
async def handshake(
    ...
    """Perform the Stage B handshake for the Crown bridge connector."""
...
async def send_heartbeat(
    ...
    *,
    ...
    """Emit a Stage B heartbeat for the Crown bridge connector."""
