...
CHECKS: Dict[str, Callable[[], bool]] = {
    ...
    "razar_quarantine_manager_agent": check_quarantine_manager_ready,
    "razar_doc_sync_agent": check_doc_sync_ready,
    "razar_checkpoint_manager_agent": check_checkpoint_ready,
    "razar_crown_link_agent": check_crown_link_ready,
...
THRESHOLDS: Dict[str, float] = {
    ...
    "runtime_manager": 0.5,
    "health_checks": 0.5,
    "razar_quarantine_manager_agent": 0.5,
    "razar_doc_sync_agent": 0.5,
    "razar_checkpoint_manager_agent": 0.5,
    "razar_crown_link_agent": 0.5,
