...
- [Legacy→Neo-APSU alignment snapshot](system_blueprint.md#legacyneo-apsu-alignment-snapshot-2025-12) – summarizes sandbox-only shims, Stage F hardware queues, and Stage G approvals captured in the refreshed migration ledger.【F:docs/system_blueprint.md†L113-L118】
