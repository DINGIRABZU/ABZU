...
- **Crown Router** now flows through the Rust crate [`neoabzu_crown`](../NEOABZU/crown/src/lib.rs), matching `crown_router.py` with built-in validation, orchestrator delegation, and telemetry hooks.
