...
- Runtime Manager (`agents/razar/runtime_manager.py`) – sequentially starts
  components and resumes from the last successful one stored in
...
Start system components with the runtime manager and resume from the last
successful step:
...
- **Root**
  ...
  - **Links:** [Chakra Overview](chakra_overview.md),
    ...
    [Root Chakra Overview](root_chakra_overview.md),
...
- **Sacral**
  ...
  - **Links:** [Chakra Overview](chakra_overview.md),
    [Chakra Status](chakra_status.md),
    [Chakra Architecture](chakra_architecture.md),
    [Emotion Memory](memory_emotion.md),
...
- **Solar Plexus**
  ...
  - **Links:** [Chakra Overview](chakra_overview.md),
    [Chakra Status](chakra_status.md),
    [Chakra Architecture](chakra_architecture.md),
    [Learning Pipeline](learning_pipeline.md),
...
- **Throat**
  ...
  - **Links:** [Chakra Overview](chakra_overview.md),
    [Chakra Status](chakra_status.md),
    [Chakra Architecture](chakra_architecture.md),
    [Communication Interfaces](communication_interfaces.md),
