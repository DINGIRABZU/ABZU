...
- **Stage C sandbox addendum** – Reference [The Absolute Protocol Addendum — Stage C Sandbox Review](The_Absolute_Protocol_addendum.md) for the latest readiness packet snapshot, cross-team review schedule, and environment-limited follow-ups that must close before hardware promotion.【F:docs/The_Absolute_Protocol_addendum.md†L1-L20】
