...
| **C3. Readiness signal sync** | @ops-team | Compile the Alpha readiness packet summarizing boot success rates, replay fidelity, and subsystem metrics. | Pull the latest telemetry from Stage A and Stage B tasks, update `PROJECT_STATUS.md` with outstanding risks, and embed the sandbox-to-hardware rehearsal bridge notes required by [The Absolute Protocol](The_Absolute_Protocol.md#sandbox-to-hardware-rehearsal-bridge). | Cross-team readiness review scheduled for **2025-09-30 17:30 UTC** with the refreshed Stage C readiness packet and the sandbox evidence captured in `logs/alpha_gate/20250927T235425Z/`; Stage D entry depends on restoring at least one NeoABZU memory layer, securing Stage C prep acceptance for operator connectors, and documenting sandbox override sign-offs before promotion.【F:docs/rehearsals/stage_c_readiness_review_packet.md†L1-L26】【F:logs/alpha_gate/20250927T235425Z/command_log.md†L1-L9】 |
| **C4. Operator MCP drills** | @ops-team | Land `OperatorMCPAdapter` for `operator_api`/`operator_upload` and confirm Stage B parity with `crown_handshake`. | Run `scripts/stage_b_smoke.py` to log the 48-hour credential rotation drill for each connector and archive the results under `logs/stage_b_rotation_drills.jsonl`, highlighting the successive windows `20250926T180300Z-PT48H`, `20250926T180231Z-PT48H`, `20250925T095833Z-PT48H`, `20250925T094604Z-PT48H`, `20251024T174210Z-PT48H`, and the baseline `20250922T101554Z-PT48H` during roadmap syncs. | Latest drill `20250927T225213Z` confirms Stage B rehearsal and Stage C prep contexts plus the `20250927T225224Z-PT48H` rotation window; bundle the handshake/heartbeat artifacts with the review packet and track remaining B3 acceptance in the readiness meeting.【F:logs/stage_c/20250927T225213Z-stage_c4_operator_mcp_drill/summary.json†L1-L131】【F:logs/stage_b_rotation_drills.jsonl†L49-L53】【F:docs/rehearsals/stage_c_readiness_review_packet.md†L16-L26】 |
