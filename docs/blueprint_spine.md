...
- **Stage A automation surface** adds `operator_api` endpoints (`POST /alpha/stage-a1-boot-telemetry`, `/alpha/stage-a2-crown-replays`, `/alpha/stage-a3-gate-shakeout`) so the dashboard can trigger boot telemetry, replay capture, and Alpha gate shakeouts. Each call streams stdout/stderr into `logs/stage_a/<run_id>/` alongside a `summary.json` manifest for roadmap evidence cross-links. The Mission Map groups these Stage A runs with the Stage B (`stage-b1-memory-proof`, `stage-b2-sonic-rehearsal`, `stage-b3-connector-rotation`) and Stage C (`stage-c1-exit-checklist`, `stage-c2-demo-storyline`) milestones under "Milestone Controls", wiring the UI buttons to the REST handlers and event log updates for artifact parity.【F:web_console/game_dashboard/dashboard.js†L180-L356】【F:web_console/game_dashboard/mission_map.js†L1-L144】【F:operator_api.py†L2184-L2421】
...
| --- | --- | --- | --- | --- | --- | --- |
| `crown_decider.py` | `neoabzu_crown::route_decision` | Gate-runner rehearsals replay Stage B rotation windows and Stage C readiness hashes before switching to the Rust decider, locking Neo-APSU parity into the bridge ledger.【F:logs/stage_b_rotation_drills.jsonl†L1-L40】【F:logs/stage_c/20251001T010101Z-readiness_packet/readiness_bundle/readiness_bundle.json†L1-L47】 | Contract suites and dashboards broadcast parity state into roadmap and PROJECT_STATUS updates so beta planning inherits live telemetry expectations.【F:tests/test_operator_transport_contract.py†L1-L210】【F:monitoring/operator_transport_pilot.md†L1-L66】【F:docs/roadmap.md†L229-L271】 | Soak notes cite Stage E dashboard hashes and sandbox diffs until heartbeat metrics land on hardware.【F:logs/stage_e/20250930T121727Z-stage_e_transport_readiness/summary.json†L1-L48】 | Stage G gate-runner parity packets prove sandbox evidence replay before sign-off with rollback transcripts and approvals.【F:logs/stage_g/20251102T090000Z-stage_g_gate_runner_hardware/summary.json†L1-L13】 | GA cutover confirms the Rust decider telemetry hash matches Stage G lineage in production.【F:logs/stage_h/20251115T090000Z-ga_hardware_cutover/summary.json†L1-L28】 |
| `crown_prompt_orchestrator.py` | `neoabzu_rag::MoGEOrchestrator` | Stage D rehearsals pair Stage B rotation windows with Stage C REST↔gRPC diffs to validate retrieval on hardware.【F:logs/stage_b_rotation_drills.jsonl†L1-L40】【F:logs/stage_c/20251031T000000Z-test/rest_grpc_handshake_diff.json†L1-L11】 | Beta-facing updates surface orchestrator telemetry through the contract suite and Grafana dashboards, highlighting sandbox deferrals in roadmap/PROJECT_STATUS feeds.【F:tests/test_operator_transport_contract.py†L211-L320】【F:monitoring/operator_transport_pilot.md†L40-L84】【F:docs/PROJECT_STATUS.md†L162-L181】 | Soak cadence keeps sandbox traces attached to dashboards until hardware parity clears aura/heartbeat gaps.【F:logs/stage_e/20250930T121727Z-stage_e_transport_readiness/summary.json†L20-L87】 | Neo-APSU Stage G approvals archive orchestrator diffs with rollback drills tied to sandbox evidence.【F:logs/stage_g/20251102T094500Z-stage_g_neo_apsu_parity/summary.json†L1-L13】 | GA readiness summary records orchestrator telemetry continuity from Stage G hardware bundles.【F:logs/stage_h/20251115T090000Z-ga_hardware_cutover/summary.json†L1-L28】 |
| `servant_model_manager.py` | `neoabzu_crown` servant bridge | Stage D bridge rehearsals reuse Stage C readiness servant logs to certify registry activation on hardware while consuming sandbox evidence.【F:logs/stage_c/20251001T010101Z-readiness_packet/readiness_bundle/readiness_bundle.json†L48-L120】 | Contract dashboards expose servant parity across transports, ensuring roadmap/status updates highlight outstanding sandbox deferrals during beta prep.【F:tests/test_operator_transport_contract.py†L1-L210】【F:monitoring/operator_transport_pilot.md†L1-L66】【F:docs/PROJECT_STATUS.md†L162-L181】 | Soak checkpoints attach sandbox servant traces to parity dashboards until hardware counters align.【F:logs/stage_e/20250930T121727Z-stage_e_transport_readiness/summary.json†L49-L87】 | Stage G gate-runner summaries archive servant rollback rehearsals with sandbox transcript references before approvals land.【F:logs/stage_g/20251102T090000Z-stage_g_gate_runner_hardware/summary.json†L1-L13】 | GA cutover notes confirm servant telemetry parity with Stage G lineage.【F:logs/stage_h/20251115T090000Z-ga_hardware_cutover/summary.json†L1-L28】 |
| `state_transition_engine.py` | `neoabzu_crown::route_inevitability` | Stage D parity packets import Stage C inevitability traces so chakra transitions are validated on hardware with sandbox provenance.【F:logs/stage_c/20251001T010101Z-readiness_packet/readiness_bundle/readiness_bundle.json†L121-L185】 | Contract suites stream inevitability spans into roadmap/status updates so beta monitoring watches deferred heartbeat telemetry in real time.【F:tests/test_operator_transport_contract.py†L1-L210】【F:monitoring/operator_transport_pilot.md†L1-L84】【F:docs/roadmap.md†L229-L271】 | Soak-week reviews retain sandbox inevitability logs and dashboard hashes until hardware parity stabilizes.【F:logs/stage_e/20250930T121727Z-stage_e_transport_readiness/summary.json†L49-L87】 | Stage G Neo-APSU parity bundle captures inevitability diffs tied to sandbox transcripts before approvals.【F:logs/stage_g/20251102T094500Z-stage_g_neo_apsu_parity/summary.json†L1-L13】 | GA readiness summary documents inevitability telemetry hash continuity from Stage G hardware bundles.【F:logs/stage_h/20251115T090000Z-ga_hardware_cutover/summary.json†L1-L28】 |
| `memory_store.py` | `neoabzu_memory::MemoryBundle` | Stage D rehearsals align Stage B rotation ledger and Stage C readiness latencies before flipping hardware writes to Rust memory.【F:logs/stage_b_rotation_drills.jsonl†L1-L40】【F:logs/stage_c/20251001T010101Z-readiness_packet/readiness_bundle/readiness_bundle.json†L1-L185】 | Transport dashboards publish memory checksum parity so roadmap/status consumers see ingestion gaps tied to sandbox evidence until hardware metrics converge.【F:tests/test_operator_transport_contract.py†L231-L320】【F:monitoring/operator_transport_pilot.md†L1-L84】【F:docs/PROJECT_STATUS.md†L162-L181】 | Soak checkpoints document sandbox latency traces plus dashboard hashes before closing outstanding deferrals.【F:logs/stage_e/20250930T121727Z-stage_e_transport_readiness/summary.json†L20-L87】 | Stage G gate-runner parity confirms memory checksums align with sandbox bundles before approvals sign off.【F:logs/stage_g/20251102T090000Z-stage_g_gate_runner_hardware/summary.json†L1-L13】 | GA cutover retains the memory parity hash from Stage G in production telemetry.【F:logs/stage_h/20251115T090000Z-ga_hardware_cutover/summary.json†L15-L28】 |
| `emotional_state.py` | `neoabzu_crown` expression pipeline | Stage D hardware checks replay Stage B rotation history and Stage C sandbox diffs to validate aura persistence before activating Neo-APSU expression flows.【F:logs/stage_b_rotation_drills.jsonl†L1-L40】【F:logs/stage_c/20251031T000000Z-test/summary.json†L1-L120】 | Contract dashboards broadcast expression telemetry parity and sandbox deferrals inside roadmap/status updates ahead of beta.【F:tests/test_operator_transport_contract.py†L1-L210】【F:monitoring/operator_transport_pilot.md†L1-L66】【F:docs/PROJECT_STATUS.md†L162-L181】 | Soak routines attach sandbox aura transcripts and dashboard hashes until hardware emits continuous heartbeats.【F:logs/stage_e/20250930T121727Z-stage_e_transport_readiness/summary.json†L49-L87】 | Stage G Neo-APSU parity approvals capture aura diffs with sandbox provenance and rollback drills.【F:logs/stage_g/20251102T094500Z-stage_g_neo_apsu_parity/summary.json†L1-L13】 | GA summary cites expression telemetry hash continuity from Stage G hardware bundles.【F:logs/stage_h/20251115T090000Z-ga_hardware_cutover/summary.json†L1-L28】 |
