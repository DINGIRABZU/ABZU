...
| [The_Absolute_Protocol.md](The_Absolute_Protocol.md) | The Absolute Protocol | **Version:** v1.0.96 **Last updated:** 2025-10-05 | `../agents/guardian.py`, `../connectors/__init__.py`, `../connectors/webrtc_connector.py`, `../scripts/validate_ignition.py` |
...
| [world_bootstrap.md](world_bootstrap.md) | World Bootstrap | Utilities for cloning and updating world configuration. | - |
