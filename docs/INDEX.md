...
| [chakra_metrics.md](chakra_metrics.md) | Chakra Metrics | This table links each chakra layer to operational metrics used for telemetry and health checks. | `../agents/chakra_healing/root_agent.py`, `../monitoring/chakra_heartbeat.py`, `../src/spiral_os/pulse_emitter.py` |
