...
| [apsu_migration_matrix.md](apsu_migration_matrix.md) | APSU Migration Matrix | Captures sandbox expectations, hardware replay requirements, and evidence maturity for every legacy→Neo-APSU bridge. | - |
