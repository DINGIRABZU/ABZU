...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `operator_api` | operator chat command dispatch | 0.3.7 | Bearer | `POST /operator/command` | Orchestration Master | active (beta-ready; Stage C4 handshake `2025-10-01T09:32:13Z` accepted `stage-b-rehearsal`/`stage-c-prep` contexts and refreshed the 48-hour ledger windows `20251205T160210Z-PT48H`, `20251001T093213Z-PT48H`, `20251024T174210Z-PT48H`, `20250926T180300Z-PT48H`, `20250926T180231Z-PT48H`, `20250925T095833Z-PT48H`, `20250925T094604Z-PT48H`, `20250922T101554Z-PT48H`) | [operator_api.py](../../operator_api.py) | [operator_protocol.md](../operator_protocol.md), [operator_mcp_audit.md](operator_mcp_audit.md), [credential_rotation_playbook.md](credential_rotation_playbook.md) | N/A |
| `operator_upload` | operator asset upload API for files, images, audio, and video | 0.3.7 | Bearer | `POST /operator/upload` | RAZAR | active (beta-ready; Stage C4 handshake `2025-10-01T09:32:13Z` mirrored the adapter session and rotation ledger windows `20251205T160210Z-PT48H`, `20251001T093213Z-PT48H`, `20251024T174210Z-PT48H`, `20250926T180300Z-PT48H`, `20250926T180231Z-PT48H`, `20250925T095833Z-PT48H`, `20250925T094604Z-PT48H`, `20250922T101554Z-PT48H`) | [operator_api.py](../../operator_api.py) | [operator_protocol.md](../operator_protocol.md), [operator_mcp_audit.md](operator_mcp_audit.md), [credential_rotation_playbook.md](credential_rotation_playbook.md) | N/A |
...
| --- | --- | --- | --- | --- | --- |
| `operator_api_stage_b` | `connectors.operator_api_stage_b` | Context `stage-b-rehearsal` accepted with channels `handshake`, `heartbeat`, `command`; session `stage-b-session` authenticated, capabilities `register`, `telemetry`, `command`, credential expiry `2025-10-03T09:32:13Z`. | `last_rotated` `2025-10-01T09:32:13Z`, rotation window `PT48H`, window id `20251001T093213Z-PT48H`, hot swap supported, token hint `operator`. | Rotation ledger refreshed via `logs/stage_b_rotation_drills.jsonl`, capturing the successive windows `20251205T160210Z-PT48H`, `20251001T093213Z-PT48H`, `20251024T174210Z-PT48H`, `20250926T180300Z-PT48H`, `20250926T180231Z-PT48H`, `20250925T095833Z-PT48H`, `20250925T094604Z-PT48H`, and the baseline `20250922T101554Z-PT48H`; handshake artifacts now link to the Stage C4 drill run `20251001T093206Z`. | [rehearsal packet](../../logs/stage_b_rehearsal_packet.json) · [smoke receipt](../../logs/stage_b/20251001T093529Z-stage_b3_connector_rotation/stage_b_smoke.json) · [rotation summary](../../logs/stage_b_rotation_drills.jsonl) |
| `operator_upload_stage_b` | `connectors.operator_upload_stage_b` | Context `stage-b-rehearsal` accepted with channels `handshake`, `heartbeat`, `upload`; operator session reuse confirmed (`stage-b-session` shared), capabilities `register`, `telemetry`, `upload`. | `last_rotated` `2025-10-01T09:32:13Z`, rotation window `PT48H`, window id `20251001T093213Z-PT48H`, hot swap supported, token hint `operator-upload`. | Rotation ledger refreshed via `logs/stage_b_rotation_drills.jsonl`, recording windows `20251205T160210Z-PT48H`, `20251001T093213Z-PT48H`, `20251024T174210Z-PT48H`, `20250926T180300Z-PT48H`, `20250926T180231Z-PT48H`, `20250925T095833Z-PT48H`, `20250925T094604Z-PT48H`, and the earlier `20250922T101554Z-PT48H`; operator upload shares the updated Stage B smoke receipt noted above. | [rehearsal packet](../../logs/stage_b_rehearsal_packet.json) · [smoke receipt](../../logs/stage_b/20251001T093529Z-stage_b3_connector_rotation/stage_b_smoke.json) · [rotation summary](../../logs/stage_b_rotation_drills.jsonl) |
| `crown_handshake_stage_b` | `connectors.crown_handshake_stage_b` | Context `stage-b-rehearsal` accepted with channels `handshake`, `heartbeat`, `mission-brief`; Stage B smoke captured `crown_handshake` version `0.2.5` from `razar/crown_handshake.py`. | `last_rotated` `2025-10-01T09:32:13Z`, rotation window `PT48H`, window id `20251001T093213Z-PT48H`, hot swap supported, token hint `crown`. | Rotation ledger refreshed via `logs/stage_b_rotation_drills.jsonl`, capturing windows `20251205T160210Z-PT48H`, `20251001T093213Z-PT48H`, `20251024T174210Z-PT48H`, `20250926T180300Z-PT48H`, `20250926T180231Z-PT48H`, `20250925T095833Z-PT48H`, `20250925T094604Z-PT48H`, and the earlier `20250922T101554Z-PT48H`; Crown evidence shares the same Stage B smoke receipt. | [rehearsal packet](../../logs/stage_b_rehearsal_packet.json) · [smoke receipt](../../logs/stage_b/20251001T093529Z-stage_b3_connector_rotation/stage_b_smoke.json) · [rotation summary](../../logs/stage_b_rotation_drills.jsonl) |

Rotation drills captured alongside the latest rehearsal confirm the operator,
upload, and Crown connectors rotated credentials on `2025-10-01T09:32:13Z`,
maintaining the declared 48-hour window (`20251001T093213Z-PT48H`) while
appending the refreshed `20251205T160210Z-PT48H` ledger entry and preserving
the prior `20251024T174210Z-PT48H`, `20250926T180300Z-PT48H`,
`20250926T180231Z-PT48H`, `20250925T095833Z-PT48H`, `20250925T094604Z-PT48H`,
and `20250922T101554Z-PT48H` windows for Stage B readiness. Review the
append-only log at
