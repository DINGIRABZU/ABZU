...
- **Readiness ledger refresh (2025-09-28)** – [`readiness_index.json`](../logs/stage_b/latest/readiness_index.json) now tracks Stage B1 run `20250928T155301Z-stage_b1_memory_proof`, which rebuilt the cortex dataset, rehydrated the emotional telemetry, and completed with all eight layers ready, zero query failures, and p95/p99 latencies of 2.501 ms/3.579 ms; Stage B2 continues to export `stage_b_rehearsal_packet.json`, and Stage B3 retains the `20250926T180300Z-PT48H` connector rotation window for sign-off.【F:logs/stage_b/latest/readiness_index.json†L1-L33】【F:logs/stage_b/20250928T155301Z-stage_b1_memory_proof/summary.json†L1-L42】【F:logs/stage_b/20250926T180250Z-stage_b3_connector_rotation/summary.json†L1-L55】
...
- **Memory and connector prerequisites:** The refreshed readiness ledger now shows Stage B1 completing with every layer ready and no query failures while the Stage C readiness sync confirms both `stage-b-rehearsal` and `stage-c-prep` connector contexts as accepted under the current rotation window `20250928T001910Z-PT48H`. Maintain the connector rotation cadence as the accepted contexts age toward the 48-hour limit.【F:logs/stage_b/latest/readiness_index.json†L1-L33】【F:logs/stage_b/20250928T153749Z-stage_b1_memory_proof/summary.json†L1-L33】【F:logs/stage_c/20250928T004857Z-stage_c3_readiness_sync/summary.json†L320-L805】【F:logs/stage_b/20250926T180250Z-stage_b3_connector_rotation/summary.json†L1-L55】
