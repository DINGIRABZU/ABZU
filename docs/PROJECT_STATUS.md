...
Stage D bridge facilitators should run weekly checkpoints against the [Stage D/E bridge review agenda](beta_bridge/agenda.md) and require teams to submit the [Stage D/E evidence request template](beta_bridge/evidence_request_template.md) with parity logs, MCP rotations, or demo bundles before slots are confirmed in the readiness ledger.
