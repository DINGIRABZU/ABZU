...
- **Connector rotation acceptance (2025-09-25)** – [`summary.json`](../logs/stage_b/20250925T100029Z-stage_b3_connector_rotation/summary.json) confirms the Stage B3 drill now archives handshake/heartbeat telemetry for all three connectors and writes the rotation ledger snapshot beside the run artifacts. The ledger documents the refreshed window `20250925T095833Z-PT48H`, extending the prior rehearsals logged at `20250925T094604Z-PT48H`, the baseline `20250922T101554Z-PT48H`, and the follow-up refresh `20251024T174210Z-PT48H` while keeping every connector within the mandated 48-hour cadence.【F:logs/stage_b/20250925T100029Z-stage_b3_connector_rotation/summary.json†L1-L40】【F:logs/stage_b_rotation_drills.jsonl†L12-L23】
...
- **Stage C3 readiness sync (2025-09-25T10:53:37Z):** The aggregate run merged Stage A3 (`20250924T115245Z-stage_a3_gate_shakeout`) and Stage B3 (`20250925T100029Z-stage_b3_connector_rotation`) summaries. Stage A still reports an exit-code-1 failure, producing the active risk note, while Stage B completed successfully; the merged snapshot remains in a "requires_attention" state until the Stage A gate is green.【F:logs/stage_c/20250925T105337Z-stage_c3_readiness_sync/summary.json†L1-L78】【F:logs/stage_c/20250925T105337Z-stage_c3_readiness_sync/summary.json†L99-L141】
- **Stage C4 operator MCP drill (2025-09-25T10:56:32Z):** The drill captured `mcp_handshake.json` and `heartbeat.json` artifacts confirming a 48-hour rotation window and credential expiry alignment. The emitted heartbeat echoed the Stage C drill event, verifying OperatorMCPAdapter parity ahead of the beta kickoff.【F:logs/stage_c/20250925T105632Z-stage_c4_operator_mcp_drill/summary.json†L1-L53】【F:logs/stage_c/20250925T105632Z-stage_c4_operator_mcp_drill/mcp_handshake.json†L1-L15】【F:logs/stage_c/20250925T105632Z-stage_c4_operator_mcp_drill/heartbeat.json†L1-L9】
