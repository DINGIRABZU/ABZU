...
- **Readiness packet assembly (2025-09-30T21:00:00Z):** `logs/stage_c/20250930T210000Z-readiness_packet/` now anchors the Stage C readiness bundle with live links into Stage A/B runs, the Stage C MCP gRPC parity trial, and a refreshed Stage C1 checklist log that records hardware rerun scheduling details. The manifest enumerates each Stage run, captures REST↔gRPC handshake parity, and surfaces the gate hardware replay window so reviewers inherit a single canonical artifact.【F:logs/stage_c/20250930T210000Z-readiness_packet/readiness_bundle/readiness_bundle.json†L1-L138】【F:logs/stage_c/20250930T210000Z-readiness_packet/checklist_logs/stage_c1_exit_checklist_summary.json†L1-L33】【F:logs/stage_c/20250930T210000Z-readiness_packet/mcp_drill/index.json†L1-L8】
...
- **gRPC pilot commitments:** The MCP drill index and trial summary confirm REST↔gRPC parity for `operator_api`, enabling the integration guild to extend gRPC handling once the hardware gap closes and documenting the rotation window feeding the pilot.【F:logs/stage_c/20250930T210000Z-readiness_packet/mcp_drill/index.json†L1-L8】【F:logs/stage_c/20251031T000000Z-test/summary.json†L1-L128】
