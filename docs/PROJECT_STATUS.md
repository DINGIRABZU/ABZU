...
| 2025-09-27T20:08:56Z | `logs/stage_a/latest/stage_a1_boot_telemetry-summary.json` | Stage A1 boot telemetry completed with sandbox overrides; Crown services used stub agents and RAZAR stayed offline in the container while recording the override summary.【F:logs/stage_a/latest/stage_a1_boot_telemetry-summary.json†L1-L30】 |
| 2025-09-27T20:07:30Z | `logs/stage_a/latest/stage_a2_crown_replays-summary.json` | Stage A2 replay capture ran all five scenarios and noted deterministic skips under the sandbox stubs for Crown orchestration and logging.【F:logs/stage_a/latest/stage_a2_crown_replays-summary.json†L1-L31】 |
| 2025-09-27T20:07:32Z | `logs/stage_a/latest/stage_a3_gate_shakeout-summary.json` | Stage A3 alpha gate shakeout succeeded with every phase marked `environment-limited`, preserving the sandbox warning bundle and summary JSON.【F:logs/stage_a/latest/stage_a3_gate_shakeout-summary.json†L1-L91】 |
...
- **Memory and connector prerequisites:** The refreshed readiness ledger shows Stage B1 running with the native bundle yet reporting a core-layer failure and pretest stub warning, while Stage B3 keeps the `stage-c-prep` connector context pending; investigate the memory fault while carrying the `20250926T180300Z-PT48H` rotation window into Stage C4 planning.【F:logs/stage_b/latest/readiness_index.json†L1-L33】【F:logs/stage_b/20250927T231955Z-stage_b1_memory_proof/summary.json†L1-L33】【F:logs/stage_c/20250927T201020Z-stage_c3_readiness_sync/readiness_bundle.json†L1-L88】【F:logs/stage_b/20250926T180250Z-stage_b3_connector_rotation/summary.json†L1-L55】
- **Stage C3 readiness sync (2025-09-27T20:10:20Z):** The latest bundle copies the refreshed Stage A run IDs (`20250927T200839Z-stage_a1_boot_telemetry`, `20250927T200728Z-stage_a2_crown_replays`, `20250927T200729Z-stage_a3_gate_shakeout`) and still flags Stage B as `requires_attention`. Stage B1 now reports the native bundle with a failed core layer and empty-cortex pretest note, Stage B3 keeps the `stage-c-prep` connector context as `pending`, and the sandbox sweep in `logs/alpha_gate/20250927T235425Z/` highlights missing coverage tooling. Cross-team readiness review is booked for **2025-09-30 17:30 UTC** so hardware owners can fold in the deferred coverage evidence before Stage D planning.【F:logs/stage_c/20250927T201020Z-stage_c3_readiness_sync/readiness_bundle.json†L1-L207】【F:logs/stage_c/20250927T201020Z-stage_c3_readiness_sync/readiness_bundle.json†L220-L340】【F:logs/alpha_gate/20250927T235425Z/command_log.md†L1-L9】
