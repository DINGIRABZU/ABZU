...
<!-- If a connector was added or modified, update [CONNECTOR_INDEX.md](../docs/connectors/CONNECTOR_INDEX.md) with version, purpose, service, status, and links, as required by [The Absolute Protocol](../docs/The_Absolute_Protocol.md). -->
...
- [ ] Connector registry updated <!-- confirm CONNECTOR_INDEX.md lists version, purpose, service, status, and links -->
